...
int main(int argc, char **argv)
{
  ...
  while (ros::ok()){
	target_pose.pose.position.x = home_pose.pose.position.x - 1.2;
	target_pose.pose.position.y = home_pose.pose.position.y - 0.5;
	...
	target_pose.pose.position.x = home_pose.pose.position.x - 0.2;
	target_pose.pose.position.y = home_pose.pose.position.y + 0.5;
